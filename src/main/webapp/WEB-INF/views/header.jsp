...
<body>
	   <header>
        <nav>
            <ul>
                ...
                <li> <a class="tooltip" data-tooltip="Message" id="btn_msg"><i class="fab fa-facebook-messenger"><span class="msg-badge "></span></i></a></li>
    ...
    <!-- "<p class='search-res'><img Align=left class='search-img'  style='width:40px;height:40px;border-radius:50% 50%;'"+
							"src='"+arr[i].member_profile+"' alt='프로필사진'/><a class='search-a' href="+"'friendpage.do?member_no="+arr[i].member_no+"'>"+
									"<span>"+arr[i].member_name+"<i class='fas fa-user-plus'></i></i></span></a><p>"; -->
				...
				success:function(data){
					if(data.check == "OK"){
						...
						for(var i = 0; i < arr.length ; i++){
							searchlist += 
							"<tr> "+ 
							 "<td><img Align=left class='search-img'  style='width:40px;height:40px;border-radius:50% 50%;' src='"+arr[i].member_profile+"'/> </td>" +
							
							"<td><a class='search-a' href='friendDetail.do?member_no="+arr[i].member_no+"'><span>"+arr[i].member_name+"</span></a></td>"+
									"<td><a title ='친구추가' href='friendDetail.do?member_no="+arr[i].member_no+"'><i class='fas fa-arrow-alt-circle-right'></i></a></td></tr>";
						}
						console.log(searchlist);
						result = "<table><colgroup><col width='30%'><col width='70%'><col width='30%'></colgroup>"+searchlist+"</table>"
						$("#search-hide").html(result);
					}else{
