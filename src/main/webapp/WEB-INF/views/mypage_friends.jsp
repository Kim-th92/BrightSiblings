				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${requestlist}" var="dto">
							<li><a href="friendDetail.do?member_no=${dto.member_no}">
									<img id="profile-img" src="${dto.member_profile}" />
									${dto.member_name}
							</a>
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach items="${list}" var="dto">
						...
						<div id="borderdiv">
							<a href="friendDetail.do?member_no=${dto.member_no}"> <img
								id="profile-img" src="${dto.member_profile}" />
								${dto.member_name}
							</a> <span><button
									onclick="window.open('chatmsglist.do?member_no=${dto.member_no}','popup','width=500px,height=530px')">
									<i class="fab fa-facebook-messenger"></i>
								</button></span> <span><button onclick="'">
