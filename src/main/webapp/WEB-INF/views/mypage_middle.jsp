			...
			<div id="main-container">
				<div id="mypage-photo">
					<div id="mypage-profileimg" style="position: relative;">
						...
						<div>
							<form method="post" id="uploadprofilepic"
								enctype="mulipart/form-data">
								<input type="file" name="file" id="profile-file"
									accept="image/gif,image/jpg,image/jpeg,image/png"
									style="display: none" />
							</form>
							<button id="profile-pic-add" title="사진편집"
								onclick="document.getElementById('profile-file').click();">
								<i class="fas fa-camera"></i>
							</button>
						</div>
						<form method="post" id="uploadprofilebgpic"
							enctype="mulipart/form-data">
							<input type="file" name="file" id="profile-bg-file"
								accept="image/gif,image/jpg,image/jpeg,image/png"
								style="display: none" />
						</form>
					...
					<div id="hidemodal">
						<div class="modalcenter">
							...
							<div id="selectBG"
								style="display: grid; grid-gap: 10px; margin-left: 40px; margin-bottom: 60px; grid-template-rows: 200px 200px; grid-template-columns: 1fr 1fr 1fr 1fr;">

							</div>
							<input type="button" class="modalbtn"
								onclick="document.getElementById('profile-bg-file').click();"
								value="배경사진 업로드"> <input type="button" class="modalbtn"
								onclick="uploadByExsist();" value="선택한 사진으로 저장">
							<form method="post" id="uploadprofilebgpic"
								enctype="mulipart/form-data">
								<input type="file" name="file" id="profile-bg-file"
									accept="image/gif,image/jpg,image/jpeg,image/png"
