...
<body>
	...
	<div>
		<form method="post" action="updateres.do"
			...
			<textarea cols="15" rows="15" name="board_content"
				style="resize: none;">${dto.board_content }</textarea>
			<div class="imgWrap">
				<c:forEach items="${url }" var="url">
					<img src="${url }" style="width: 200px; height: auto;">
				</c:forEach>
			</div>
			<input type="file" name="file1" multiple> <input type="text"
				value="${dto.board_regdate}" readonly="readonly"> <input
				type="submit" value="완료"> <input type="button" value="뒤로"
				onclick="">
