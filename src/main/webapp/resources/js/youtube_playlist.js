...
const apiKey = 'AIzaSyCHNQMK-uSXvRbCRZPrI8rsZrTjZSxjprc';
const videoChannel = document.querySelector('#video-channel');
const videoContainer = document.querySelector('#video-container');
const channelId = 'UCpg89Ys3E4BaLGgEEWVmI9g';
...
function showChannel(data) {
    ...
    <div class="col-md-6 mb-4 text-center">
        ...
        <br />
        <a href="https://www.youtube.com/channel/${myId}" target="_blank" class="btn btn-danger btn-sm">Go to Youtube Channel</a>
    </div>
