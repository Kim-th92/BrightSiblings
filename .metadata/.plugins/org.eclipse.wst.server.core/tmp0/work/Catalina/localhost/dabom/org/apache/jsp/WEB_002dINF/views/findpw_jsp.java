 ...
 * Generated at: 2021-01-01 18:21:03 UTC
...
public final class findpw_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <button class=\"submit\" onclick=\"namecheck()\"><span >인증번호 발송</span></button>\n");
      ...
      out.write("\t\t\t\t\t\t$('.authkey').show();\n");
      out.write("\t\t\t\t\t\ttimer();\n");
      out.write("\t\t\t\t\t\t$.ajax({\n");
      out.write("\t\t\t\t\t\t\turl:'mailsend.do?member_email='+member_email,\n");
      out.write("\t\t\t\t\t\t\ttype:'GET',\n");
      out.write("\t\t\t\t\t\t\tsuccess:function(mgg){\n");
      out.write("\t\t\t\t\t\t\t\tconsole.log(mgg)\n");
      out.write("\t\t\t\t\t\t\t\talert(mag.authkey);\n");
      out.write("\t\t\t\t\t\t\t},\n");
      ...
      out.write("\tvar authkeyinput = $('.authkey').val();\n");
      out.write("\tif(!authkeyinput){\n");
      out.write("\t\talert(\"인증번호를 입력하세요\");\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("\tif(authkeyinput !=  authkey){\n");
      out.write("\t\talert(\"잘못된 인증번호입니다 인증번호를 다시 입력해주세요. \");\n");
      out.write("\t\tauthkeyinput.val = \"\";\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("\tif(authkeyinput == authkey){\n");
      ...
      out.write("\t//타이머 \n");
      out.write(" \tvar time = 180; //  3분시간 제한\n");
      out.write(" \tvar min = \"\";\n");
      out.write(" \tvar sec = \"\"; \n");
      out.write(" \t\n");
      out.write(" \t//1초씩 실행되는 함수 \n");
      out.write(" \tvar x = setInterval(function(){\n");
      out.write(" \t\tmin = parseInt(time/60) ;//몫계산\n");
      out.write(" \t\tsec = time%60;               //나머지 계산\n");
      out.write(" \t\t\n");
      out.write(" \t\tdocument.getElementById(\"countdown\").innerHTML = min + ':' +sec ;\n");
      out.write(" \t\t\n");
      out.write(" \t\tif(time<0){\n");
      out.write(" \t\t\tclearInterval(x); \n");
      out.write(" \t\t\tdocument.getElementById(\"countdown\").innerHTML = \"인증시간이 초과되었습니다. 다시 시도해주세요.\";\n");
      out.write(" \t\t}\n");
      out.write(" \t},1000);\n");
      out.write("\n");
      out.write("}\n");
